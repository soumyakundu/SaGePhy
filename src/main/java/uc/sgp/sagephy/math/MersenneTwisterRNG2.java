...
*/
public class MersenneTwisterRNG2 extends Random implements RepeatableRNG
{
...
*/
public MersenneTwisterRNG2()
{
   this(DefaultSeedGenerator2.getInstance().generateSeed(SEED_SIZE_BYTES));
}
...
*/
public MersenneTwisterRNG2(SeedGenerator seedGenerator) throws SeedException
{
...
*/
public MersenneTwisterRNG2(byte[] seed)
{
