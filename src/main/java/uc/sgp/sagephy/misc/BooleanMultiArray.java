 ...
 */
public class BooleanMultiArray implements MultiArray {
	 ...
	 */
	public BooleanMultiArray(int[] lengths) {
	 ...
	 * @return the value.
	 */
	public boolean getSafe(int[] index) {
	 ...
	 * @param value the value to set at the index.
	 */
	public void setSafe(int[] index, boolean value) {
		if (index == null || index.length != this.lengths.length) {
