...
import uc.sgp.sagephy.topology.RTree;
import uc.sgp.sagephy.topology.StringMap;
 ...
 */
public class BranchRelaxer implements SaGePhyApp {
	...
	public void main(String[] args) throws Exception {
		try {
			...
			if (params.help || args.length < 1) {
				...
				sb.append(
						"================================================================================\n" +
						"BranchRelaxer is part of the SaGePhy-GenPhyloData suite of tools for creating\n" +
                ...
                */
				sb.append("Usage:\n" +
						"    java -jar sagephy-X.Y.Z.jar BranchRelaxer [options] <tree> <model> <arg1> <arg2> <...>\n");
